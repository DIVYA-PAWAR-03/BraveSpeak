  ...
  return (
    <form action="https://api.web3forms.com/submit" method="POST">
      <section className='bg-gray-100 m-20 shadow-2xl rounded-2xl'>
        ...
        <div className="main-container flex flex-col lg:flex-row justify-around p-10 gap-8">
          ...
          <div className="left-container flex flex-col">
            ...
            <input
              ...
              required
              className='p-2 mt-2 border border-purple-500 w-[300px] md:w-[500px] text-purple-950 rounded-[10px] focus:outline-none focus:ring-1 focus:ring-purple-600'
            /> <br />
