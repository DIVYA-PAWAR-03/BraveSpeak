      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:space-x-8 space-y-8 md:space-y-0">
        ...
        <div className="flex-1">
          ...
          <p className="text-[12px] font-light mt-1">
            Voices that matter. Stories that inspire.
          </p>
        </div>
        ...
        <div className="flex-1">
          ...
          <p className="text-sm">
            Email:{" "}
            <a
              href="mailto:support@bravespeak.org"
        ...
        <div className="flex-1">
          <p className="text-sm">
            BraveSpeak is dedicated to creating a safe space for voices to be
            heard, stories to be shared, and justice to be pursued.
          </p>
        </div>
      </div>
